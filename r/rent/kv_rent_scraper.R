...
write.csv2(tallinn_analysis, file = paste0("results/rent/kv_posting_data_",Sys.Date(),".csv"),row.names = FALSE)
saveRDS(object = tallinn_analysis, file = paste0("data/rent/tallinn_data_",Sys.Date(),".RDS"))
